...
You can easily create your own collections for any type of content, such as teaching materials, courses, apps, or short stories. To do this, edit the collections in the [\_config.yml](_config.yml) file, create a corresponding folder, and create a landing page for your collection, similar to [\_pages/publications.md](_pages/publications.md).
